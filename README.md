...
Tools: Python, Pandas, Numpy, Seaborn, MatPlotLib, Supervised Machine Learning Binary Classification Model, PostgreSQL, Tableau, Jupyter Notebook, and Visual Studio Code.<br/>
